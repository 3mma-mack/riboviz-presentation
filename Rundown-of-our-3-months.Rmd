...
```{r, out.width = "300"}
knitr::include_graphics("https://github.com/3mma-mack/riboviz-presentation/blob/2a0a531cd0ac941c99b1eff515acbc21bfc0c55c/Images/Codon_pair_workflow.JPG")
```  
...
```{r, out.width = "300"}
knitr::include_graphics("https://github.com/3mma-mack/riboviz-presentation/blob/rmd-version/Images/Gamble_et_al_figure.JPG")
```  
